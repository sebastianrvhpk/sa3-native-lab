...
3. Add prompt-search mode presets and scorer-cost notes next. The first
   generated-take run-comparison rows now exist, so the remaining prompt-search
   work is about stronger defaults and Medium/MPS guidance.
