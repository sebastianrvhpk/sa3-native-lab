...
3. Add prompt-search scorer-cost notes next. Mode 2/3 presets and the first
   generated-take run-comparison rows now exist, so the remaining prompt-search
   work is about clearer Medium/MPS guidance and richer vocabulary/axis editing.
