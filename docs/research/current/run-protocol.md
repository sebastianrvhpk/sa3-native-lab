...
| Residual steering | layer-probe rows, selected top-k layers, vector metadata, alpha sweep, descriptor/listening deltas | residual feature atlas, repeat probe run |
