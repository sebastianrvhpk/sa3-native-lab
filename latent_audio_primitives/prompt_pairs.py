"""Prompt-pair presets for contrastive residual probing and steering axes."""
...
class PromptPair:
    """Positive/negative prompts for one residual probe comparison."""
...
def pairs_for_axis(axis: str, pairs: list[PromptPair] | None = None) -> list[PromptPair]:
    """Return prompt pairs matching one residual probe axis."""
