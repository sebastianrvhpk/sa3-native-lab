"""Residual activation examples, vectors, and probe rows.

This root module owns SA3 residual-stream research objects after activations
have already been captured. It does not know how to find SA3 layers or run the
model. Procedures collect examples; this module turns those examples into
vectors and microscope/selector rows.
"""
...
class ActivationExample:
    """One generated prompt/audio example and its mean residual activations."""
...
class LayerProbeRow:
    """One layer, layer-window, or layer-timestep ranking row."""
...
class SteeringVectors:
    """Residual-stream steering vector container."""
...
def mean_difference_vectors(
    ...
    *,
    ...
    """Compute contrastive residual directions from mean activations."""
...
def probe_layer_rows(
    ...
    *,
    ...
    """Rank residual layers with linear or centroid probes."""

    method_key = _probe_method_key(method)
...
def probe_layer_window_rows(
    ...
    *,
    ...
    """Rank observed residual layer-window cells with the same probes as layers."""
...
def probe_layer_timestep_rows(
    ...
    *,
    ...
    """Rank observed residual layer/timestep cells from sampler callback records."""
...
def flatten_layer_windows(
    ...
    """Flatten nested layer/window activations into tuple-key dictionaries."""
...
def _probe_method_key(method: str) -> str:
...
def _require_torch():
    try:
        ...
        raise RuntimeError("PyTorch is required for residual probes.") from exc
    return torch
